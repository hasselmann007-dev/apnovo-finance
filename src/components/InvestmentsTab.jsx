...
export default function InvestmentsTab({ session }) {
  ...
  if (loading) return <div className="p-10 text-center font-bold text-gray-400">Carregando ativos...</div>;

  return (
    <div className="animate-in fade-in duration-500 space-y-8 pb-32">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-primary-600 p-7 rounded-2xl shadow-xl shadow-primary-600/30 relative overflow-hidden group">
          ...
          <p className="text-sm font-bold text-primary-100 uppercase tracking-widest mb-1 relative z-10">Patrimônio Total</p>
        ...
        <div className="bg-white dark:bg-slate-800 p-7 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm relative overflow-hidden group">
          ...
          <p className="text-sm font-bold text-gray-400 dark:text-slate-400 uppercase tracking-widest mb-1 relative z-10">Rendimento Acumulado</p>
          <p className="text-3xl font-black text-gray-900 dark:text-white relative z-10">+ R$ {rendimentoEstimadoMes.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 p-7 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm relative overflow-hidden group">
          ...
          <p className="text-sm font-bold text-gray-400 dark:text-slate-400 uppercase tracking-widest mb-1 relative z-10">Rentabilidade Média</p>
          <p className="text-3xl font-black text-primary-600 dark:text-primary-400 relative z-10">+ {rentabilidadeMedia.toFixed(2)}%</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm">
          <div className="flex justify-between items-center mb-8">
             <h3 className="text-xl font-black text-gray-800 dark:text-white">Alocação da Carteira</h3>
        ...
        <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm flex flex-col">
          <div className="flex justify-between items-center mb-6">
             <h3 className="text-xl font-black text-gray-800 dark:text-white">Meus Ativos</h3>
          ...
          <div className="space-y-4 flex-1 overflow-y-auto pr-2">
            {portfolio.length === 0 ? (
                ...
                <div key={item.id} className="flex flex-col md:flex-row md:items-center justify-between p-4 bg-gray-50 dark:bg-slate-700/30 rounded-2xl hover:bg-gray-100 dark:hover:bg-slate-700/60 transition-colors group border border-transparent dark:border-slate-700 hover:border-gray-200 dark:hover:border-slate-600 gap-4">
                    ...
                    <div>
                        <p className="font-bold text-gray-900 dark:text-white">{item.ativo}</p>
                ...
                <form onSubmit={handleSave} className="p-8 space-y-6">
                    <div className="grid grid-cols-1 gap-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1 mb-2 block">Aumento/Rent. (%)</label>
                                <input
                                    type="number"
                                    step="0.01"
