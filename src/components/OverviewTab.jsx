  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-slate-800 p-7 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm relative overflow-hidden group hover:border-primary-100 transition-colors">
          ...
          <p className="text-sm font-bold text-gray-400 dark:text-slate-400 uppercase tracking-widest mb-1 relative z-10">Entradas</p>
          <p className="text-3xl font-black text-gray-900 dark:text-white relative z-10">R$ {totals.receitas.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</p>
        </div>

        <div className="bg-white dark:bg-slate-800 p-7 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm relative overflow-hidden group hover:border-rose-100 transition-colors">
          ...
          <p className="text-sm font-bold text-gray-400 dark:text-slate-400 uppercase tracking-widest mb-1 relative z-10">Saídas</p>
          <p className="text-3xl font-black text-gray-900 dark:text-white relative z-10">R$ {totals.despesas.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</p>
        </div>

        <div className="bg-white dark:bg-slate-800 p-7 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm ring-2 ring-primary-500/10 relative overflow-hidden group hover:border-primary-200 transition-colors">
          ...
          <div className="flex items-center justify-between mb-4 relative z-10">
            ...
            <span className={`text-xs font-black px-3 py-1.5 rounded-xl ${totals.saldo >= 0 ? 'bg-primary-50 text-primary-600' : 'bg-rose-50 text-rose-600'}`}>
              {economiaPercent}% economizado
            </span>
          </div>
          <p className="text-sm font-bold text-gray-400 dark:text-slate-400 uppercase tracking-widest mb-1 relative z-10">Saldo Atual</p>
          <p className={`text-3xl font-black relative z-10 ${totals.saldo >= 0 ? 'text-primary-600 dark:text-primary-400' : 'text-rose-600 dark:text-rose-400'}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm flex flex-col justify-center text-center px-10 relative overflow-hidden group">
          ...
          <h3 className="text-2xl font-black text-gray-900 dark:text-white mb-4 relative z-10">Saúde das Finanças</h3>
      ...
      <div id="historico-table" className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm overflow-hidden mt-8">
        <div className="p-8 border-b border-gray-50 dark:border-slate-700 flex justify-between items-center bg-gray-50/30 dark:bg-slate-800/50">
          <h3 className="text-xl font-black text-gray-800 dark:text-white">Histórico Recente</h3>
        ...
        <div className="overflow-x-auto min-h-[300px]">
          {transactions.length === 0 ? (
            ...
            <table className="w-full text-left">
               <thead className="bg-gray-50/50 dark:bg-slate-700/50 text-gray-400 dark:text-slate-400 text-[10px] uppercase font-black tracking-widest hidden md:table-header-group">
                 <tr>
                 ...
                 {transactions.map((t) => (
                    <tr key={t.id} className="group hover:bg-primary-50/30 dark:hover:bg-slate-700/30 transition-all flex flex-col md:table-row p-4 md:p-0">
                      <td className="px-2 md:px-8 py-4 md:py-6">
                        <p className="font-bold text-gray-800 dark:text-white">{t.descricao}</p>
                      ...
                      <td className="px-2 md:px-8 py-2 md:py-6">
                        <p className={`font-black text-lg md:text-md ${t.tipo === 'receita' ? 'text-primary-600 dark:text-primary-400' : 'text-gray-900 dark:text-slate-100'}`}>
